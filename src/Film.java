...
public class Film {
    ...
    public static void main(String[] args) {
        ...
        filmList.add(new Film("tt0439572", "The Flash", 2023, 7.3));
        filmList.add(new Film("tt9362722", "Spider-Man:Across the spider-verse", 2023, 9.0));
        filmList.add(new Film("tt5090568", "Transformers:Rise of the beasts", 2023, 6.6));
        filmList.add(new Film("tt1630029", "Avatar:The way of water", 2022, 7.6));
        filmList.add(new Film("tt5971474", "The Little Mermaid", 2023, 7.2));
        filmList.add(new Film("tt12263384", "Extraction", 2023, 7.2));
        filmList.add(new Film("tt5433140", "Fast X", 2023, 6.0));
